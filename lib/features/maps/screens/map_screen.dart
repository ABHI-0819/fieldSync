...
import 'package:fieldsync/features/survey/screens/tree_survey_form.dart';
...
class _MapScreenState extends State<MapScreen> with TickerProviderStateMixin {
  ...
  // Draggable pin
  LatLng? _draggablePin;

  // Tree markers for clustering
  ...
  void _addTreeAtLocation(LatLng location) {
    setState(() {
      _treeMarkers.add(
        Marker(
          point: location,
  ...
  void _moveDraggablePinToCurrentLocation() {
    if (_currentPosition != null) {
      setState(() {
        _draggablePin = _currentPosition;
      });
      _mapController.move(_currentPosition!, _currentZoom);
    }
  }
        ...
        children: [
          ...
          FlutterMap(
            ...
            children: [
              ...
              if (_treeMarkers.isNotEmpty)
                MarkerClusterLayerWidget(
                  options: MarkerClusterLayerOptions(
                    maxClusterRadius: 80,
                    size: const Size(50, 50),
                    markers: _treeMarkers,
                  ...
                  markers: [
                    Marker(
                      ...
                      child:  GestureDetector(
                        ...
                        onTap: () => _addTreeAtLocation(_draggablePin!),
                        child: Container(
                          decoration: BoxDecoration(
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              onPressed: _isLocating ? null : () async {
                ...
                _moveDraggablePinToCurrentLocation();
              },
              backgroundColor: Colors.white,
              elevation: 4,
              child: _isLocating
